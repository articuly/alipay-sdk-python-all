...
class AlipayUserAuthUserinfoApplyRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayUserAuthUserinfoApplyModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayUserAuthUserinfoApplyModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.user.auth.userinfo.apply'
