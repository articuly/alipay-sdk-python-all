...
class AlipayUserAntarchiveIdentityrelationAddRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayUserAntarchiveIdentityrelationAddModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayUserAntarchiveIdentityrelationAddModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.user.antarchive.identityrelation.add'
