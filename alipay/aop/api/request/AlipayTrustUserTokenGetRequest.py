...
class AlipayTrustUserTokenGetRequest(object):

    def __init__(self, biz_model=None):
        self._biz_model = biz_model
        self._ali_trust_user_info = None
        self._version = "1.0"
    ...
    @property
    def ali_trust_user_info(self):
        return self._ali_trust_user_info

    @ali_trust_user_info.setter
    def ali_trust_user_info(self, value):
        self._ali_trust_user_info = value
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.trust.user.token.get'
