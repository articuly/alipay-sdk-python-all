...
class AlipayFundTransRefundRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayFundTransRefundModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayFundTransRefundModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.fund.trans.refund'
