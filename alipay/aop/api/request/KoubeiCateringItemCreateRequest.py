...
class KoubeiCateringItemCreateRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, KoubeiCateringItemCreateModel):
            self._biz_content = value
        else:
            self._biz_content = KoubeiCateringItemCreateModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'koubei.catering.item.create'
