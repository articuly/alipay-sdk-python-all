...
class AlipayOpenAgentConfirmRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayOpenAgentConfirmModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayOpenAgentConfirmModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.open.agent.confirm'
