...
class KoubeiMarketingCampaignMemberRelationCreateRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, KoubeiMarketingCampaignMemberRelationCreateModel):
            self._biz_content = value
        else:
            self._biz_content = KoubeiMarketingCampaignMemberRelationCreateModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'koubei.marketing.campaign.member.relation.create'
