...
class AlipayEbppInvoiceAuthUnsignRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayEbppInvoiceAuthUnsignModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayEbppInvoiceAuthUnsignModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.ebpp.invoice.auth.unsign'
