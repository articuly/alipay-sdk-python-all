...
class AlipayFundTransAppPayRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayFundTransAppPayModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayFundTransAppPayModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.fund.trans.app.pay'
