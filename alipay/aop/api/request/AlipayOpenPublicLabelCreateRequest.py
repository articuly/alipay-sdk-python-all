...
class AlipayOpenPublicLabelCreateRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayOpenPublicLabelCreateModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayOpenPublicLabelCreateModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.open.public.label.create'
