...
class AlipayTradeMergePrecreateRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayTradeMergePrecreateModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayTradeMergePrecreateModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.trade.merge.precreate'
