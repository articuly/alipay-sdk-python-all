...
class AlipayEcoMycarMaintainOrderserverNotifyRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayEcoMycarMaintainOrderserverNotifyModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayEcoMycarMaintainOrderserverNotifyModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.eco.mycar.maintain.orderserver.notify'
