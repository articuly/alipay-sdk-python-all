...
class AlipayMarketingFacetofaceDecodeUseRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayMarketingFacetofaceDecodeUseModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayMarketingFacetofaceDecodeUseModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.marketing.facetoface.decode.use'
