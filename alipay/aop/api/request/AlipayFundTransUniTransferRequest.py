...
class AlipayFundTransUniTransferRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayFundTransUniTransferModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayFundTransUniTransferModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.fund.trans.uni.transfer'
