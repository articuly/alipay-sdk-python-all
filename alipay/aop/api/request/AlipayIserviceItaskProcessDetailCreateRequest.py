...
class AlipayIserviceItaskProcessDetailCreateRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayIserviceItaskProcessDetailCreateModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayIserviceItaskProcessDetailCreateModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.iservice.itask.process.detail.create'
