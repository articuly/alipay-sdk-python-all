...
class AlipayTradeFastpayRefundQueryRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayTradeFastpayRefundQueryModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayTradeFastpayRefundQueryModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.trade.fastpay.refund.query'
