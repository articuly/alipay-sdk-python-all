...
class KoubeiCateringDishRecommendQueryRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, KoubeiCateringDishRecommendQueryModel):
            self._biz_content = value
        else:
            self._biz_content = KoubeiCateringDishRecommendQueryModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'koubei.catering.dish.recommend.query'
