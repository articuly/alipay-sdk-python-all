...
class AlipayOpenServicemarketYcstestQueryRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayOpenServicemarketYcstestQueryModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayOpenServicemarketYcstestQueryModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.open.servicemarket.ycstest.query'
