...
class AlipayFundTransAacollectPayorderCreateRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayFundTransAacollectPayorderCreateModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayFundTransAacollectPayorderCreateModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.fund.trans.aacollect.payorder.create'
