...
class AlipayTradeCreateRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayTradeCreateModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayTradeCreateModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.trade.create'
