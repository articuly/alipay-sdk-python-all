...
class AlipayEcoEduKtDownloadurlQueryRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayEcoEduKtDownloadurlQueryModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayEcoEduKtDownloadurlQueryModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.eco.edu.kt.downloadurl.query'
