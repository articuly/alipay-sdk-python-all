...
class MybankCreditGuaranteeWriteoffPayRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, MybankCreditGuaranteeWriteoffPayModel):
            self._biz_content = value
        else:
            self._biz_content = MybankCreditGuaranteeWriteoffPayModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'mybank.credit.guarantee.writeoff.pay'
