...
class AlipayUserAgreementPageSignRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayUserAgreementPageSignModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayUserAgreementPageSignModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.user.agreement.page.sign'
