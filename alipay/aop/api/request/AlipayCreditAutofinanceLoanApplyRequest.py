...
class AlipayCreditAutofinanceLoanApplyRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayCreditAutofinanceLoanApplyModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayCreditAutofinanceLoanApplyModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.credit.autofinance.loan.apply'
