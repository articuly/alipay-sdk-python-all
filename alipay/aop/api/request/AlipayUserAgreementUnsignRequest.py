...
class AlipayUserAgreementUnsignRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayUserAgreementUnsignModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayUserAgreementUnsignModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.user.agreement.unsign'
