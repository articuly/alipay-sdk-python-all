...
class AlipayTradeCancelRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayTradeCancelModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayTradeCancelModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.trade.cancel'
