...
class AlipayMerchantWeikeSettleQueryRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayMerchantWeikeSettleQueryModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayMerchantWeikeSettleQueryModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.merchant.weike.settle.query'
