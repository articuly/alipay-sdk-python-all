...
class KoubeiServindustryExerciseMemberphoneSyncRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, KoubeiServindustryExerciseMemberphoneSyncModel):
            self._biz_content = value
        else:
            self._biz_content = KoubeiServindustryExerciseMemberphoneSyncModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'koubei.servindustry.exercise.memberphone.sync'
