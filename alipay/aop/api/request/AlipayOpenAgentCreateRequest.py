...
class AlipayOpenAgentCreateRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayOpenAgentCreateModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayOpenAgentCreateModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.open.agent.create'
