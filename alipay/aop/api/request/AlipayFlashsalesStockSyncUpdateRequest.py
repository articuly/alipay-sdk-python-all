    ...
    def get_params(self):
        ...
        if self.out_product_id:
            if hasattr(self.out_product_id, 'to_alipay_dict'):
                params['out_product_id'] = json.dumps(obj=self.out_product_id.to_alipay_dict(), use_decimal=True, ensure_ascii=False, sort_keys=True, separators=(',', ':'))
            else:
        ...
        if self.stock:
            if hasattr(self.stock, 'to_alipay_dict'):
                params['stock'] = json.dumps(obj=self.stock.to_alipay_dict(), use_decimal=True, ensure_ascii=False, sort_keys=True, separators=(',', ':'))
            else:
