...
class KoubeiContentContentinfoModifyRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, KoubeiContentContentinfoModifyModel):
            self._biz_content = value
        else:
            self._biz_content = KoubeiContentContentinfoModifyModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'koubei.content.contentinfo.modify'
