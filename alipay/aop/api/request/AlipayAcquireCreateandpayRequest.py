    ...
    def get_params(self):
        ...
        if self.alipay_ca_request:
            if hasattr(self.alipay_ca_request, 'to_alipay_dict'):
                params['alipay_ca_request'] = json.dumps(obj=self.alipay_ca_request.to_alipay_dict(), use_decimal=True, ensure_ascii=False, sort_keys=True, separators=(',', ':'))
            else:
        ...
        if self.buyer_email:
            if hasattr(self.buyer_email, 'to_alipay_dict'):
                params['buyer_email'] = json.dumps(obj=self.buyer_email.to_alipay_dict(), use_decimal=True, ensure_ascii=False, sort_keys=True, separators=(',', ':'))
            else:
                params['buyer_email'] = self.buyer_email
        if self.buyer_id:
            if hasattr(self.buyer_id, 'to_alipay_dict'):
                params['buyer_id'] = json.dumps(obj=self.buyer_id.to_alipay_dict(), use_decimal=True, ensure_ascii=False, sort_keys=True, separators=(',', ':'))
            else:
        ...
        if self.dynamic_id:
            if hasattr(self.dynamic_id, 'to_alipay_dict'):
                params['dynamic_id'] = json.dumps(obj=self.dynamic_id.to_alipay_dict(), use_decimal=True, ensure_ascii=False, sort_keys=True, separators=(',', ':'))
            else:
                params['dynamic_id'] = self.dynamic_id
        if self.dynamic_id_type:
            if hasattr(self.dynamic_id_type, 'to_alipay_dict'):
                params['dynamic_id_type'] = json.dumps(obj=self.dynamic_id_type.to_alipay_dict(), use_decimal=True, ensure_ascii=False, sort_keys=True, separators=(',', ':'))
            else:
        ...
        if self.format_type:
            if hasattr(self.format_type, 'to_alipay_dict'):
                params['format_type'] = json.dumps(obj=self.format_type.to_alipay_dict(), use_decimal=True, ensure_ascii=False, sort_keys=True, separators=(',', ':'))
            else:
        ...
        if self.mcard_parameters:
            if hasattr(self.mcard_parameters, 'to_alipay_dict'):
                params['mcard_parameters'] = json.dumps(obj=self.mcard_parameters.to_alipay_dict(), use_decimal=True, ensure_ascii=False, sort_keys=True, separators=(',', ':'))
            else:
