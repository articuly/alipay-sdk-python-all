...
class KoubeiMarketingCampaignRetailDmSetRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, KoubeiMarketingCampaignRetailDmSetModel):
            self._biz_content = value
        else:
            self._biz_content = KoubeiMarketingCampaignRetailDmSetModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'koubei.marketing.campaign.retail.dm.set'
