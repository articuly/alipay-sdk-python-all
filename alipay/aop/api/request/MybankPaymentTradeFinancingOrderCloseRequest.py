...
class MybankPaymentTradeFinancingOrderCloseRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, MybankPaymentTradeFinancingOrderCloseModel):
            self._biz_content = value
        else:
            self._biz_content = MybankPaymentTradeFinancingOrderCloseModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'mybank.payment.trade.financing.order.close'
