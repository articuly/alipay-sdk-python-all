...
class AlipaySecurityDataDatabusSendRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipaySecurityDataDatabusSendModel):
            self._biz_content = value
        else:
            self._biz_content = AlipaySecurityDataDatabusSendModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.security.data.databus.send'
