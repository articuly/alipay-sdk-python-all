...
class AlipayEbppInvoiceTitleListGetRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayEbppInvoiceTitleListGetModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayEbppInvoiceTitleListGetModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.ebpp.invoice.title.list.get'
