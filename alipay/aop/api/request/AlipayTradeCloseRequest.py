...
class AlipayTradeCloseRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayTradeCloseModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayTradeCloseModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.trade.close'
