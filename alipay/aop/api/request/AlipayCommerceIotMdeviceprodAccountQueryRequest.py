...
class AlipayCommerceIotMdeviceprodAccountQueryRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayCommerceIotMdeviceprodAccountQueryModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayCommerceIotMdeviceprodAccountQueryModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.commerce.iot.mdeviceprod.account.query'
