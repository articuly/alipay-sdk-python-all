...
class AlipayMerchantOrderSyncRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayMerchantOrderSyncModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayMerchantOrderSyncModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.merchant.order.sync'
