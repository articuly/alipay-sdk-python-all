...
class MybankCreditSceneprodVidGetRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, MybankCreditSceneprodVidGetModel):
            self._biz_content = value
        else:
            self._biz_content = MybankCreditSceneprodVidGetModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'mybank.credit.sceneprod.vid.get'
