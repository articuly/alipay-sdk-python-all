...
class ZhimaCreditEpRoleGetRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, ZhimaCreditEpRoleGetModel):
            self._biz_content = value
        else:
            self._biz_content = ZhimaCreditEpRoleGetModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'zhima.credit.ep.role.get'
