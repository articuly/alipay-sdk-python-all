...
class AlipayUserAccountDeviceInfoUploadRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayUserAccountDeviceInfoUploadModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayUserAccountDeviceInfoUploadModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.user.account.device.info.upload'
