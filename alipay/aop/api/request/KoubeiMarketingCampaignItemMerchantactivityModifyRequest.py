...
class KoubeiMarketingCampaignItemMerchantactivityModifyRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, KoubeiMarketingCampaignItemMerchantactivityModifyModel):
            self._biz_content = value
        else:
            self._biz_content = KoubeiMarketingCampaignItemMerchantactivityModifyModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'koubei.marketing.campaign.item.merchantactivity.modify'
