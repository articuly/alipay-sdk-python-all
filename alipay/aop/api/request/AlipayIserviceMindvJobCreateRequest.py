...
class AlipayIserviceMindvJobCreateRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayIserviceMindvJobCreateModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayIserviceMindvJobCreateModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.iservice.mindv.job.create'
