...
class KoubeiRetailWmsOutboundworkCreateRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, KoubeiRetailWmsOutboundworkCreateModel):
            self._biz_content = value
        else:
            self._biz_content = KoubeiRetailWmsOutboundworkCreateModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'koubei.retail.wms.outboundwork.create'
