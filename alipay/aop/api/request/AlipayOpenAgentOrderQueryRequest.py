...
class AlipayOpenAgentOrderQueryRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayOpenAgentOrderQueryModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayOpenAgentOrderQueryModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.open.agent.order.query'
