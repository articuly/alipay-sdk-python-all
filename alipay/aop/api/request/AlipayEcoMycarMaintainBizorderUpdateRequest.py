...
class AlipayEcoMycarMaintainBizorderUpdateRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayEcoMycarMaintainBizorderUpdateModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayEcoMycarMaintainBizorderUpdateModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.eco.mycar.maintain.bizorder.update'
