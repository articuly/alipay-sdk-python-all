...
class AlipayCommerceIotDevicelistCreateRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayCommerceIotDevicelistCreateModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayCommerceIotDevicelistCreateModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.commerce.iot.devicelist.create'
