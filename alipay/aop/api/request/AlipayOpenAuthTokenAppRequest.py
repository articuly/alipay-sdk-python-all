...
class AlipayOpenAuthTokenAppRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayOpenAuthTokenAppModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayOpenAuthTokenAppModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.open.auth.token.app'
