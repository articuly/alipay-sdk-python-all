...
class ZhimaCustomerCertificationQueryRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, ZhimaCustomerCertificationQueryModel):
            self._biz_content = value
        else:
            self._biz_content = ZhimaCustomerCertificationQueryModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'zhima.customer.certification.query'
