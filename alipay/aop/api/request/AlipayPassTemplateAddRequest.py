...
class AlipayPassTemplateAddRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayPassTemplateAddModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayPassTemplateAddModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.pass.template.add'
