...
class AlipayFundCouponWufuCardQueryRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayFundCouponWufuCardQueryModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayFundCouponWufuCardQueryModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.fund.coupon.wufu.card.query'
