...
class KoubeiMerchantOperatorModifyRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, KoubeiMerchantOperatorModifyModel):
            self._biz_content = value
        else:
            self._biz_content = KoubeiMerchantOperatorModifyModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'koubei.merchant.operator.modify'
