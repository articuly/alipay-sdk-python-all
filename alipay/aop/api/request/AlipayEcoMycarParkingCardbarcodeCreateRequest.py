...
class AlipayEcoMycarParkingCardbarcodeCreateRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayEcoMycarParkingCardbarcodeCreateModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayEcoMycarParkingCardbarcodeCreateModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.eco.mycar.parking.cardbarcode.create'
