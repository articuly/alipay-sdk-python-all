...
class AlipayFundTransCommonQueryRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayFundTransCommonQueryModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayFundTransCommonQueryModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.fund.trans.common.query'
