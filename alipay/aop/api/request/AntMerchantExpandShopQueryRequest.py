...
class AntMerchantExpandShopQueryRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AntMerchantExpandShopQueryModel):
            self._biz_content = value
        else:
            self._biz_content = AntMerchantExpandShopQueryModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'ant.merchant.expand.shop.query'
