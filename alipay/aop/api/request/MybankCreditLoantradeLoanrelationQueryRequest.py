...
class MybankCreditLoantradeLoanrelationQueryRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, MybankCreditLoantradeLoanrelationQueryModel):
            self._biz_content = value
        else:
            self._biz_content = MybankCreditLoantradeLoanrelationQueryModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'mybank.credit.loantrade.loanrelation.query'
