...
class KoubeiMemberDataOutuserinfoModifyRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, KoubeiMemberDataOutuserinfoModifyModel):
            self._biz_content = value
        else:
            self._biz_content = KoubeiMemberDataOutuserinfoModifyModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'koubei.member.data.outuserinfo.modify'
