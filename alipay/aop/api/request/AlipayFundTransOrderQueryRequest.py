...
class AlipayFundTransOrderQueryRequest(object):
    ...
    def biz_content(self, value):
        if isinstance(value, AlipayFundTransOrderQueryModel):
            self._biz_content = value
        else:
            self._biz_content = AlipayFundTransOrderQueryModel.from_alipay_dict(value)
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.fund.trans.order.query'
