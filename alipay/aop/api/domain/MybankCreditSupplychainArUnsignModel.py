...
class MybankCreditSupplychainArUnsignModel(object):

    def __init__(self):
        self._ar_pd_code = None
        self._request_id = None
        self._seller_ar_no = None
        self._shop_id = None
    ...
    @property
    def seller_ar_no(self):
        return self._seller_ar_no

    @seller_ar_no.setter
    def seller_ar_no(self, value):
        self._seller_ar_no = value
    @property
    def shop_id(self):
    ...
    def to_alipay_dict(self):
        ...
        if self.seller_ar_no:
            if hasattr(self.seller_ar_no, 'to_alipay_dict'):
                params['seller_ar_no'] = self.seller_ar_no.to_alipay_dict()
            else:
                params['seller_ar_no'] = self.seller_ar_no
        if self.shop_id:
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = MybankCreditSupplychainArUnsignModel()
        if 'ar_pd_code' in d:
            o.ar_pd_code = d['ar_pd_code']
        if 'request_id' in d:
            o.request_id = d['request_id']
        if 'seller_ar_no' in d:
            o.seller_ar_no = d['seller_ar_no']
        if 'shop_id' in d:
            o.shop_id = d['shop_id']
        if 'shop_name' in d:
