...
class KoubeiMarketingCampaignRecruitShopQueryModel(object):
    ...
    def to_alipay_dict(self):
        ...
        if self.invitee:
            if hasattr(self.invitee, 'to_alipay_dict'):
                params['invitee'] = self.invitee.to_alipay_dict()
            else:
                params['invitee'] = self.invitee
        if self.operator_id:
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = KoubeiMarketingCampaignRecruitShopQueryModel()
        if 'camp_id' in d:
            o.camp_id = d['camp_id']
        if 'invitee' in d:
            o.invitee = d['invitee']
