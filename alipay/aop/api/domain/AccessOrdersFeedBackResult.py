...
class AccessOrdersFeedBackResult(object):
    ...
    def to_alipay_dict(self):
        ...
        if self.feedback_id:
            if hasattr(self.feedback_id, 'to_alipay_dict'):
                params['feedback_id'] = self.feedback_id.to_alipay_dict()
            else:
                params['feedback_id'] = self.feedback_id
        if self.order_type:
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AccessOrdersFeedBackResult()
        if 'error_code' in d:
            o.error_code = d['error_code']
        if 'error_desc' in d:
            o.error_desc = d['error_desc']
        if 'feedback_id' in d:
            o.feedback_id = d['feedback_id']
        if 'order_type' in d:
