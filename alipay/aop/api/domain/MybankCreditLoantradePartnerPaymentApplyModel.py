...
from alipay.aop.api.domain.PaymentAccountInfo import PaymentAccountInfo
from alipay.aop.api.domain.PaymentAccountInfo import PaymentAccountInfo


class MybankCreditLoantradePartnerPaymentApplyModel(object):
    ...
    def payee_account_list(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, PaymentAccountInfo):
                    self._payee_account_list.append(i)
                else:
                    self._payee_account_list.append(PaymentAccountInfo.from_alipay_dict(i))
    @property
        ...
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, PaymentAccountInfo):
                    ...
                    self._payer_account_list.append(PaymentAccountInfo.from_alipay_dict(i))
    @property
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = MybankCreditLoantradePartnerPaymentApplyModel()
        if 'amount' in d:
            o.amount = d['amount']
