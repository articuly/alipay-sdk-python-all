...
class KoubeiCateringPosPaymodeModifyModel(object):
    ...
    @property
    def old_pay_name(self):
        return self._old_pay_name

    @old_pay_name.setter
    def old_pay_name(self, value):
        self._old_pay_name = value
    @property
    def pay_code(self):
    ...
    def to_alipay_dict(self):
        ...
        if self.old_pay_name:
            if hasattr(self.old_pay_name, 'to_alipay_dict'):
                params['old_pay_name'] = self.old_pay_name.to_alipay_dict()
            else:
                params['old_pay_name'] = self.old_pay_name
        if self.pay_code:
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = KoubeiCateringPosPaymodeModifyModel()
        if 'accounting' in d:
        ...
        if 'old_pay_name' in d:
            o.old_pay_name = d['old_pay_name']
        if 'pay_code' in d:
