...
class ShopRec(object):

    def __init__(self):
        self._address = None
        self._brand_name = None
        self._busi_area = None
        self._city_id = None
        self._cuisine = None
        self._distance = None
        self._ext_info = None
    ...
    @property
    def busi_area(self):
        return self._busi_area

    @busi_area.setter
    def busi_area(self, value):
        self._busi_area = value
    @property
    def city_id(self):
    ...
    @property
    def shop_detail_url(self):
        return self._shop_detail_url

    @shop_detail_url.setter
    def shop_detail_url(self, value):
        self._shop_detail_url = value
    @property
    def shop_id(self):
        ...
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, VoucherRec):
                    ...
                    self._voucher_list.append(VoucherRec.from_alipay_dict(i))
    ...
    def to_alipay_dict(self):
        ...
        if self.busi_area:
            if hasattr(self.busi_area, 'to_alipay_dict'):
                params['busi_area'] = self.busi_area.to_alipay_dict()
            else:
                params['busi_area'] = self.busi_area
        if self.city_id:
        ...
        if self.shop_detail_url:
            if hasattr(self.shop_detail_url, 'to_alipay_dict'):
                params['shop_detail_url'] = self.shop_detail_url.to_alipay_dict()
            else:
                params['shop_detail_url'] = self.shop_detail_url
        if self.shop_id:
    ...
    def from_alipay_dict(d):
        ...
        if 'shop_detail_url' in d:
            o.shop_detail_url = d['shop_detail_url']
        if 'shop_id' in d:
            o.shop_id = d['shop_id']
