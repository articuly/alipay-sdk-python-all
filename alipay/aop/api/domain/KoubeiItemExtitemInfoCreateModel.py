...
class KoubeiItemExtitemInfoCreateModel(object):
    ...
    def need_modify(self):
        return self._need_modify

    @need_modify.setter
    def need_modify(self, value):
        self._need_modify = value
    @property
    def pack(self):
        return self._pack
    ...
    def to_alipay_dict(self):
        ...
        if self.need_modify:
            if hasattr(self.need_modify, 'to_alipay_dict'):
                params['need_modify'] = self.need_modify.to_alipay_dict()
            else:
                params['need_modify'] = self.need_modify
        if self.pack:
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = KoubeiItemExtitemInfoCreateModel()
