...
from alipay.aop.api.domain.RefundExtendParams import RefundExtendParams


class AlipayTradePageRefundModel(object):
    ...
    def extend_params(self, value):
        if isinstance(value, RefundExtendParams):
            self._extend_params = value
        else:
            self._extend_params = RefundExtendParams.from_alipay_dict(value)
    @property
