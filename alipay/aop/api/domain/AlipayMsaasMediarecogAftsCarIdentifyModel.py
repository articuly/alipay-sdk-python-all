...
class AlipayMsaasMediarecogAftsCarIdentifyModel(object):
    ...
    @kilometres.setter
    def kilometres(self, value):
        self._kilometres = value
    @property
    def url(self):
        return self._url
    ...
    def to_alipay_dict(self):
        ...
        if self.h:
            if hasattr(self.h, 'to_alipay_dict'):
                ...
                params['h'] = self.h
        if self.kilometres:
            if hasattr(self.kilometres, 'to_alipay_dict'):
                params['kilometres'] = self.kilometres.to_alipay_dict()
            else:
                params['kilometres'] = self.kilometres
        if self.url:
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayMsaasMediarecogAftsCarIdentifyModel()
        if 'ext' in d:
            o.ext = d['ext']
        if 'h' in d:
            o.h = d['h']
        if 'kilometres' in d:
            o.kilometres = d['kilometres']
        if 'url' in d:
            o.url = d['url']
        if 'user_id' in d:
            o.user_id = d['user_id']
