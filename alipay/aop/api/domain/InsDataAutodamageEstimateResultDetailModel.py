...
class InsDataAutodamageEstimateResultDetailModel(object):
    ...
    @property
    def origin_images(self):
        return self._origin_images

    @origin_images.setter
    def origin_images(self, value):
        self._origin_images = value
    @property
    def parts_cost(self):
    ...
    def to_alipay_dict(self):
        ...
        if self.origin_images:
            if hasattr(self.origin_images, 'to_alipay_dict'):
                params['origin_images'] = self.origin_images.to_alipay_dict()
            else:
                params['origin_images'] = self.origin_images
        if self.parts_cost:
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = InsDataAutodamageEstimateResultDetailModel()
        ...
        if 'origin_images' in d:
            o.origin_images = d['origin_images']
        if 'parts_cost' in d:
