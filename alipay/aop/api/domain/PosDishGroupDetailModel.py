...
class PosDishGroupDetailModel(object):
    ...
    @property
    def detail_dish_name(self):
        return self._detail_dish_name

    @detail_dish_name.setter
    def detail_dish_name(self, value):
        self._detail_dish_name = value
    @property
    ...
    def to_alipay_dict(self):
        ...
        if self.detail_dish_name:
            if hasattr(self.detail_dish_name, 'to_alipay_dict'):
                params['detail_dish_name'] = self.detail_dish_name.to_alipay_dict()
            else:
                params['detail_dish_name'] = self.detail_dish_name
    ...
    def from_alipay_dict(d):
        ...
        if 'detail_dish_name' in d:
            o.detail_dish_name = d['detail_dish_name']
