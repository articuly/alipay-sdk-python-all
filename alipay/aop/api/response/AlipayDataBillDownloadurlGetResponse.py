...
class AlipayDataBillDownloadurlGetResponse(AlipayResponse):

    def __init__(self):
        super(AlipayDataBillDownloadurlGetResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayDataBillDownloadurlGetResponse, self).parse_response_content(response_content)
