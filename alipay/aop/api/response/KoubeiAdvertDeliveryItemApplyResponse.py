...
class KoubeiAdvertDeliveryItemApplyResponse(AlipayResponse):

    def __init__(self):
        super(KoubeiAdvertDeliveryItemApplyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(KoubeiAdvertDeliveryItemApplyResponse, self).parse_response_content(response_content)
