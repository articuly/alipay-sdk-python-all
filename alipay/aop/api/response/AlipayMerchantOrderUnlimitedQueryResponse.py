...
class AlipayMerchantOrderUnlimitedQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayMerchantOrderUnlimitedQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayMerchantOrderUnlimitedQueryResponse, self).parse_response_content(response_content)
