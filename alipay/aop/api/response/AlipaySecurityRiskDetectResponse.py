...
class AlipaySecurityRiskDetectResponse(AlipayResponse):

    def __init__(self):
        super(AlipaySecurityRiskDetectResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipaySecurityRiskDetectResponse, self).parse_response_content(response_content)
