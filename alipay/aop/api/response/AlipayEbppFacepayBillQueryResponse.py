...
class AlipayEbppFacepayBillQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayEbppFacepayBillQueryResponse, self).__init__()
        self._bill_no = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayEbppFacepayBillQueryResponse, self).parse_response_content(response_content)
