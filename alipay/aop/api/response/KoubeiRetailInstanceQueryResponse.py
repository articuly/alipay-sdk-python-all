...
class KoubeiRetailInstanceQueryResponse(AlipayResponse):

    def __init__(self):
        super(KoubeiRetailInstanceQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(KoubeiRetailInstanceQueryResponse, self).parse_response_content(response_content)
