...
class AlipayOpenPublicTemplateMessageGetResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOpenPublicTemplateMessageGetResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOpenPublicTemplateMessageGetResponse, self).parse_response_content(response_content)
