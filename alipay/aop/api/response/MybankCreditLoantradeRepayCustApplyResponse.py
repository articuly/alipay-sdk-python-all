...
class MybankCreditLoantradeRepayCustApplyResponse(AlipayResponse):

    def __init__(self):
        super(MybankCreditLoantradeRepayCustApplyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(MybankCreditLoantradeRepayCustApplyResponse, self).parse_response_content(response_content)
