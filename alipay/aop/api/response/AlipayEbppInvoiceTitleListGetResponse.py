...
class AlipayEbppInvoiceTitleListGetResponse(AlipayResponse):

    def __init__(self):
        super(AlipayEbppInvoiceTitleListGetResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayEbppInvoiceTitleListGetResponse, self).parse_response_content(response_content)
