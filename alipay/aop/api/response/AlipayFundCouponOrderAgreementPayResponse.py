...
class AlipayFundCouponOrderAgreementPayResponse(AlipayResponse):

    def __init__(self):
        super(AlipayFundCouponOrderAgreementPayResponse, self).__init__()
        self._amount = None
        self._auth_no = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayFundCouponOrderAgreementPayResponse, self).parse_response_content(response_content)
