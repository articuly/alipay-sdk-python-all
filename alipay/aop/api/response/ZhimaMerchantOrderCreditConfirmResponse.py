...
class ZhimaMerchantOrderCreditConfirmResponse(AlipayResponse):

    def __init__(self):
        super(ZhimaMerchantOrderCreditConfirmResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(ZhimaMerchantOrderCreditConfirmResponse, self).parse_response_content(response_content)
