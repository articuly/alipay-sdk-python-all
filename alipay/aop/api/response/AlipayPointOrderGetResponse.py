...
class AlipayPointOrderGetResponse(AlipayResponse):

    def __init__(self):
        super(AlipayPointOrderGetResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayPointOrderGetResponse, self).parse_response_content(response_content)
