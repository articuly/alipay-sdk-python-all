...
class AlipayCommerceCityfacilitatorVoucherQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceCityfacilitatorVoucherQueryResponse, self).__init__()
        self._amount = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceCityfacilitatorVoucherQueryResponse, self).parse_response_content(response_content)
