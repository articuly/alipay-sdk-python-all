...
class MybankCreditLoantradeLoanarRepayResponse(AlipayResponse):

    def __init__(self):
        super(MybankCreditLoantradeLoanarRepayResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(MybankCreditLoantradeLoanarRepayResponse, self).parse_response_content(response_content)
