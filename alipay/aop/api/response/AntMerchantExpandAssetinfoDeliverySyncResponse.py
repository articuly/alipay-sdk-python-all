...
class AntMerchantExpandAssetinfoDeliverySyncResponse(AlipayResponse):

    def __init__(self):
        super(AntMerchantExpandAssetinfoDeliverySyncResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AntMerchantExpandAssetinfoDeliverySyncResponse, self).parse_response_content(response_content)
