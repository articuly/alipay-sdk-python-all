...
class KoubeiMarketingCampaignActivityOfflineResponse(AlipayResponse):

    def __init__(self):
        super(KoubeiMarketingCampaignActivityOfflineResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(KoubeiMarketingCampaignActivityOfflineResponse, self).parse_response_content(response_content)
