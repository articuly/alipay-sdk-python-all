...
class KoubeiSalesKbassetStuffFeedbackstockorderSyncResponse(AlipayResponse):

    def __init__(self):
        super(KoubeiSalesKbassetStuffFeedbackstockorderSyncResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(KoubeiSalesKbassetStuffFeedbackstockorderSyncResponse, self).parse_response_content(response_content)
