...
class AlipayCommerceIotDapplyOrderCancelResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceIotDapplyOrderCancelResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceIotDapplyOrderCancelResponse, self).parse_response_content(response_content)
