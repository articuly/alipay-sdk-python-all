...
class AlipayEbppFlowStatusQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayEbppFlowStatusQueryResponse, self).__init__()
        self._ext_msg = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayEbppFlowStatusQueryResponse, self).parse_response_content(response_content)
