...
class KoubeiCateringOrderPayDisburseResponse(AlipayResponse):

    def __init__(self):
        super(KoubeiCateringOrderPayDisburseResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(KoubeiCateringOrderPayDisburseResponse, self).parse_response_content(response_content)
