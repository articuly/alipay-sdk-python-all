...
class AlipayUserAuthZhimaperInternalApplyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayUserAuthZhimaperInternalApplyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayUserAuthZhimaperInternalApplyResponse, self).parse_response_content(response_content)
