...
class AntMerchantExpandAssetinfoProduceSyncResponse(AlipayResponse):

    def __init__(self):
        super(AntMerchantExpandAssetinfoProduceSyncResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AntMerchantExpandAssetinfoProduceSyncResponse, self).parse_response_content(response_content)
