...
class AlipayEbppJfexportMerchantbillQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayEbppJfexportMerchantbillQueryResponse, self).__init__()
        self._amount = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayEbppJfexportMerchantbillQueryResponse, self).parse_response_content(response_content)
