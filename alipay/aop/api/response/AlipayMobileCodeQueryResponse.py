...
class AlipayMobileCodeQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayMobileCodeQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayMobileCodeQueryResponse, self).parse_response_content(response_content)
