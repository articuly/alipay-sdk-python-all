...
class AlipayEcoMycarOrderStatusQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayEcoMycarOrderStatusQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayEcoMycarOrderStatusQueryResponse, self).parse_response_content(response_content)
