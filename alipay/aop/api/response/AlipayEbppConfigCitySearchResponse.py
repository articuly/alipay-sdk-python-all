...
class AlipayEbppConfigCitySearchResponse(AlipayResponse):

    def __init__(self):
        super(AlipayEbppConfigCitySearchResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayEbppConfigCitySearchResponse, self).parse_response_content(response_content)
