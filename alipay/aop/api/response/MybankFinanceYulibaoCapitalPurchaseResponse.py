...
class MybankFinanceYulibaoCapitalPurchaseResponse(AlipayResponse):

    def __init__(self):
        super(MybankFinanceYulibaoCapitalPurchaseResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(MybankFinanceYulibaoCapitalPurchaseResponse, self).parse_response_content(response_content)
