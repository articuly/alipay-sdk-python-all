...
class AlipayOpenMiniVersionUploadResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOpenMiniVersionUploadResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOpenMiniVersionUploadResponse, self).parse_response_content(response_content)
