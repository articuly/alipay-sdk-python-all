...
class AlipayCommerceIotDapplyRefundCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceIotDapplyRefundCreateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceIotDapplyRefundCreateResponse, self).parse_response_content(response_content)
