...
class KoubeiRetailWmsGoodsQueryResponse(AlipayResponse):

    def __init__(self):
        super(KoubeiRetailWmsGoodsQueryResponse, self).__init__()
        self._goods = None
    ...
    def parse_response_content(self, response_content):
        response = super(KoubeiRetailWmsGoodsQueryResponse, self).parse_response_content(response_content)
