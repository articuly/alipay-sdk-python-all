...
class MybankPaymentTradeNormalpayOrderPayResponse(AlipayResponse):

    def __init__(self):
        super(MybankPaymentTradeNormalpayOrderPayResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(MybankPaymentTradeNormalpayOrderPayResponse, self).parse_response_content(response_content)
