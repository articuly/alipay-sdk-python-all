...
class MybankCreditSceneprodLoanConfirmResponse(AlipayResponse):

    def __init__(self):
        super(MybankCreditSceneprodLoanConfirmResponse, self).__init__()
        self._apply_no = None
    ...
    def parse_response_content(self, response_content):
        response = super(MybankCreditSceneprodLoanConfirmResponse, self).parse_response_content(response_content)
