...
class KoubeiCateringDishMaterialCreateResponse(AlipayResponse):

    def __init__(self):
        super(KoubeiCateringDishMaterialCreateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(KoubeiCateringDishMaterialCreateResponse, self).parse_response_content(response_content)
