...
class KoubeiMarketingCampaignMerchantActivityCreateResponse(AlipayResponse):

    def __init__(self):
        super(KoubeiMarketingCampaignMerchantActivityCreateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(KoubeiMarketingCampaignMerchantActivityCreateResponse, self).parse_response_content(response_content)
