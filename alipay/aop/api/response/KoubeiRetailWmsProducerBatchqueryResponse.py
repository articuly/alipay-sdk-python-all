...
class KoubeiRetailWmsProducerBatchqueryResponse(AlipayResponse):

    def __init__(self):
        super(KoubeiRetailWmsProducerBatchqueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(KoubeiRetailWmsProducerBatchqueryResponse, self).parse_response_content(response_content)
