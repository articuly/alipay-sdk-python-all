...
class AlipayOpenMiniBaseinfoAmapQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOpenMiniBaseinfoAmapQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOpenMiniBaseinfoAmapQueryResponse, self).parse_response_content(response_content)
