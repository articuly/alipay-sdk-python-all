...
class AlipayFundTransOrderQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayFundTransOrderQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayFundTransOrderQueryResponse, self).parse_response_content(response_content)
