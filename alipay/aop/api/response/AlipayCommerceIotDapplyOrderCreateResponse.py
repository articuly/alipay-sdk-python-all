...
class AlipayCommerceIotDapplyOrderCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceIotDapplyOrderCreateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceIotDapplyOrderCreateResponse, self).parse_response_content(response_content)
