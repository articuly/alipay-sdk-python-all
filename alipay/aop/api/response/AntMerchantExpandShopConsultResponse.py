...
class AntMerchantExpandShopConsultResponse(AlipayResponse):

    def __init__(self):
        super(AntMerchantExpandShopConsultResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AntMerchantExpandShopConsultResponse, self).parse_response_content(response_content)
