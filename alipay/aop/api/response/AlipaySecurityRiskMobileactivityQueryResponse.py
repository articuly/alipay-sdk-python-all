...
class AlipaySecurityRiskMobileactivityQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipaySecurityRiskMobileactivityQueryResponse, self).__init__()
        self._has_risk = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipaySecurityRiskMobileactivityQueryResponse, self).parse_response_content(response_content)
