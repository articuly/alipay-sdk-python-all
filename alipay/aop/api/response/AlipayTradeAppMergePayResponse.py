...
class AlipayTradeAppMergePayResponse(AlipayResponse):

    def __init__(self):
        super(AlipayTradeAppMergePayResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayTradeAppMergePayResponse, self).parse_response_content(response_content)
