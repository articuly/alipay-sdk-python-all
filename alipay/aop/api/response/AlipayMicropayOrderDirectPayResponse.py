...
class AlipayMicropayOrderDirectPayResponse(AlipayResponse):

    def __init__(self):
        super(AlipayMicropayOrderDirectPayResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayMicropayOrderDirectPayResponse, self).parse_response_content(response_content)
