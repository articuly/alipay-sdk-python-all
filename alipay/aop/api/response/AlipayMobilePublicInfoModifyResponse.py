...
class AlipayMobilePublicInfoModifyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayMobilePublicInfoModifyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayMobilePublicInfoModifyResponse, self).parse_response_content(response_content)
