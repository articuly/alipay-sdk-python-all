...
class AlipayAcquireQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayAcquireQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayAcquireQueryResponse, self).parse_response_content(response_content)
