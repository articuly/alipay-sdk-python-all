...
class AlipayCommerceIotDapplyRefundConfirmResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceIotDapplyRefundConfirmResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceIotDapplyRefundConfirmResponse, self).parse_response_content(response_content)
