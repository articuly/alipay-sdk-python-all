...
class ZhimaCreditEpSceneRatingQueryResponse(AlipayResponse):

    def __init__(self):
        super(ZhimaCreditEpSceneRatingQueryResponse, self).__init__()
        self._amount = None
    ...
    def parse_response_content(self, response_content):
        response = super(ZhimaCreditEpSceneRatingQueryResponse, self).parse_response_content(response_content)
