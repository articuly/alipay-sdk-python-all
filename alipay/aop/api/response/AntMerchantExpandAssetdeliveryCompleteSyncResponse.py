...
class AntMerchantExpandAssetdeliveryCompleteSyncResponse(AlipayResponse):

    def __init__(self):
        super(AntMerchantExpandAssetdeliveryCompleteSyncResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AntMerchantExpandAssetdeliveryCompleteSyncResponse, self).parse_response_content(response_content)
