...
class KoubeiAdvertCommissionChannelCreateResponse(AlipayResponse):

    def __init__(self):
        super(KoubeiAdvertCommissionChannelCreateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(KoubeiAdvertCommissionChannelCreateResponse, self).parse_response_content(response_content)
