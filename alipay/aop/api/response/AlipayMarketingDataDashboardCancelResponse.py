...
class AlipayMarketingDataDashboardCancelResponse(AlipayResponse):

    def __init__(self):
        super(AlipayMarketingDataDashboardCancelResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayMarketingDataDashboardCancelResponse, self).parse_response_content(response_content)
