...
class AlipayTradeWapMergePayResponse(AlipayResponse):

    def __init__(self):
        super(AlipayTradeWapMergePayResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayTradeWapMergePayResponse, self).parse_response_content(response_content)
