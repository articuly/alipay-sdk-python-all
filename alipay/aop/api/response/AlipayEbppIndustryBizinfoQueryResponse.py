...
class AlipayEbppIndustryBizinfoQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayEbppIndustryBizinfoQueryResponse, self).__init__()
        self._biz_inst = None
        self._biz_type = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayEbppIndustryBizinfoQueryResponse, self).parse_response_content(response_content)
