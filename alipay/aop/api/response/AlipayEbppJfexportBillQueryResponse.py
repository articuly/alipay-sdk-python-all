...
class AlipayEbppJfexportBillQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayEbppJfexportBillQueryResponse, self).__init__()
        self._amount = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayEbppJfexportBillQueryResponse, self).parse_response_content(response_content)
