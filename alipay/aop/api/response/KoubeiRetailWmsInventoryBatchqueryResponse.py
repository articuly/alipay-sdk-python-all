...
class KoubeiRetailWmsInventoryBatchqueryResponse(AlipayResponse):

    def __init__(self):
        super(KoubeiRetailWmsInventoryBatchqueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(KoubeiRetailWmsInventoryBatchqueryResponse, self).parse_response_content(response_content)
