...
class AlipayEbppIndustryBizinfoApplyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayEbppIndustryBizinfoApplyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayEbppIndustryBizinfoApplyResponse, self).parse_response_content(response_content)
