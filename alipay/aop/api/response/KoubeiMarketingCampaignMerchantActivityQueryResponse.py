...
class KoubeiMarketingCampaignMerchantActivityQueryResponse(AlipayResponse):

    def __init__(self):
        super(KoubeiMarketingCampaignMerchantActivityQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(KoubeiMarketingCampaignMerchantActivityQueryResponse, self).parse_response_content(response_content)
