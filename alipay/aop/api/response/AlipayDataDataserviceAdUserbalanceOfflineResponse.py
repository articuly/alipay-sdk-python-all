...
class AlipayDataDataserviceAdUserbalanceOfflineResponse(AlipayResponse):

    def __init__(self):
        super(AlipayDataDataserviceAdUserbalanceOfflineResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayDataDataserviceAdUserbalanceOfflineResponse, self).parse_response_content(response_content)
