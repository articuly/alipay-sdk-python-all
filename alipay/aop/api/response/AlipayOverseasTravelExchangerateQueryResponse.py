...
class AlipayOverseasTravelExchangerateQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOverseasTravelExchangerateQueryResponse, self).__init__()
        self._currency = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOverseasTravelExchangerateQueryResponse, self).parse_response_content(response_content)
