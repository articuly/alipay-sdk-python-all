...
class ZhimaMerchantCloseloopDataUploadResponse(AlipayResponse):

    def __init__(self):
        super(ZhimaMerchantCloseloopDataUploadResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(ZhimaMerchantCloseloopDataUploadResponse, self).parse_response_content(response_content)
