...
class AlipayPcreditHuabeiAuthOrderFreezeResponse(AlipayResponse):

    def __init__(self):
        super(AlipayPcreditHuabeiAuthOrderFreezeResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayPcreditHuabeiAuthOrderFreezeResponse, self).parse_response_content(response_content)
