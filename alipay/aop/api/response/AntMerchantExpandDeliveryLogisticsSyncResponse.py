...
class AntMerchantExpandDeliveryLogisticsSyncResponse(AlipayResponse):

    def __init__(self):
        super(AntMerchantExpandDeliveryLogisticsSyncResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AntMerchantExpandDeliveryLogisticsSyncResponse, self).parse_response_content(response_content)
