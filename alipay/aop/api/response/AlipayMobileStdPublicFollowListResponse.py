...
class AlipayMobileStdPublicFollowListResponse(AlipayResponse):

    def __init__(self):
        super(AlipayMobileStdPublicFollowListResponse, self).__init__()
        self._count = None
        self._data = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayMobileStdPublicFollowListResponse, self).parse_response_content(response_content)
