...
class AlipayEcoCplifeBillDeleteResponse(AlipayResponse):

    def __init__(self):
        super(AlipayEcoCplifeBillDeleteResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayEcoCplifeBillDeleteResponse, self).parse_response_content(response_content)
